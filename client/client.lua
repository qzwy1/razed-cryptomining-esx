...
RegisterNetEvent('razed-cryptomining:client:CryptoMiningMenu', function()
    ESX.TriggerServerCallback('razed-cryptomining:server:showBalance', function(balance)
    lib.registerContext({
        id = 'cryptomenuon',
...
RegisterNetEvent('razed-cryptomining:client:UpgradeCryptoMining', function()
    ESX.TriggerServerCallback('razed-cryptomining:server:showGPU', function(GPUType)
    ESX.TriggerServerCallback('razed-cryptomining:server:checkGPUImage', function(image)
