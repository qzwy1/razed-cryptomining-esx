# DISCLAIMER
This script has been edited & converted to ESX by mips, @.qzwy on Discord. I do NOT provide any support. I do NOT take any credits for the original script. You can change everything in the config. For my next work, I'm probably going to convert the [Renewed-phone](https://github.com/Renewed-Scripts/qb-phone) next, not sure tho.

# ORIGINAL SCRIPT [HERE](https://github.com/planeklm/razed-cryptomining)
